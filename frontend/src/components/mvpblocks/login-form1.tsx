  ...
  return (
    <main className="bg-background flex min-h-screen w-full flex-col items-center justify-center sm:px-4">
      <div className="w-full space-y-4 sm:max-w-md">
        ...
        <div className="bg-card space-y-6 p-4 py-6 border border-border sm:rounded-lg sm:p-6 transition-colors duration-300">
          <div className="grid grid-cols-3 gap-x-3">
            <button
              ...
              className="hover:bg-secondary flex items-center justify-center rounded-lg border border-border py-2.5 duration-150 transition-colors"
            >
              <svg
                className="h-5 w-5"
                viewBox="0 0 48 48"
            ...
            <button
              ...
              className="hover:bg-secondary flex items-center justify-center rounded-lg border border-border py-2.5 duration-150 transition-colors text-foreground"
            >
              <Github size={24} />
            </button>
          </div>
          <div className="relative">
            <span className="bg-border block h-px w-full"></span>
            <p className="absolute inset-x-0 -top-2 mx-auto inline-block w-fit bg-card px-2 text-sm text-muted-foreground transition-colors">
              Or continue with
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              disabled={isLoading}
              className="w-full flex items-center justify-center rounded-lg bg-rose-600 px-4 py-2 font-medium text-white duration-150 hover:bg-rose-500 active:bg-rose-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="text-center">
          <a href="#" className="text-muted-foreground hover:text-rose-600 transition-colors">
            Forgot password?
          </a>
        </div>
      </div>
